    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100 px-4 py-20 mb-3 dark:bg-gray-900 dark:text-white">
      <div className="w-full max-w-md p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          {/* Email Field */}
          <div>
            <label className="block text-gray-700 dark:text-white font-medium mb-2 text-left">
              Email
            </label>
            <input
              type="email"
          ...
          <div className="relative">
            <label className="dark:text-white block text-gray-700 font-medium mb-2 text-left">
              Password
            </label>
            <input
